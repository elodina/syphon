...
import (
	...
	"github.com/elodina/syphon/framework/Godeps/_workspace/src/github.com/mesos/mesos-go/scheduler"
	"github.com/elodina/syphon/framework/Godeps/_workspace/src/github.com/stealthly/siesta"
	"io/ioutil"
	"net/http"
	"time"
)
